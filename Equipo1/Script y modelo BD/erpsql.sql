...
CREATE TABLE `tbl_autorizacionordenescompra` (
  ...
  `tbl_OrdenesCompra_No.Orden` int NOT NULL,
  `tbl_Encabezado_Compras_No.Orden` int NOT NULL,
  PRIMARY KEY (`id_numeroDeAutorizacion`),
  KEY `fk_tbl_autorizacionordenescompra_tbl_OrdenesCompra1_idx` (`tbl_OrdenesCompra_No.Orden`),
  KEY `fk_tbl_autorizacionordenescompra_tbl_Encabezado_Compras1_idx` (`tbl_Encabezado_Compras_No.Orden`),
  CONSTRAINT `fk_tbl_autorizacionordenescompra_tbl_Encabezado_Compras1` FOREIGN KEY (`tbl_Encabezado_Compras_No.Orden`) REFERENCES `tbl_compras` (`No.Orden`),
  CONSTRAINT `fk_tbl_autorizacionordenescompra_tbl_OrdenesCompra1` FOREIGN KEY (`tbl_OrdenesCompra_No.Orden`) REFERENCES `tbl_ordenescompra` (`No.Orden`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tbl_clientes` VALUES (1,'alonos','alex','a','a','a'),(2,'Lucas','hernandez','zon2','l@mail.com','123412'),(3,'David','Martinez','Mixco','dav@mail.com','187652'),(13,'Jose','Martinez','zona4','josm@mail.com','42142341'),(14,'Lucas','Hernandez','zona4','lc','412421'),(15,'David','a','a','a','a'),(16,'a','d','d','d','d'),(17,'a','a','a','a','a'),(18,'a','a','a','a','a'),(19,'e','e','e','e','e'),(20,'h','h','h','h','h'),(21,'g','g','g','g','g'),(22,'t','t','t','t','t'),(23,'t','t','t','t','t'),(24,'1b','b','b','b','b'),(25,'b','b','b','b','b'),(26,'1','1','1','1','1'),(27,'2','2','2','2','2'),(28,'barrios','balines','b','b','b'),(29,'b','b','b','b','bb'),(30,'n','n','n','n','n'),(31,'4','4','4','4','4'),(32,'1','1','1','1','1'),(33,'1','1','1','1','1'),(34,'1','1','1','1','1');
...
CREATE TABLE `tbl_compras` (
  `No.Orden` int NOT NULL AUTO_INCREMENT,
  ...
  `recibidoIgualSolicitado_EncComp` int DEFAULT NULL,
  `fechaVencimientoPago_EncComp` date DEFAULT NULL,
  PRIMARY KEY (`No.Orden`),
  ...
  CONSTRAINT `id_cuenta` FOREIGN KEY (`id_cuenta`) REFERENCES `tbl_cuentasbancarias` (`id_cuenta`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tbl_cotizaciones` VALUES (0,'2024-04-11','2024-04-26'),(1,'2024-04-11','2024-04-26'),(2,'2024-04-11','2024-04-26'),(3,'2024-04-11','2024-04-26'),(4,'2024-04-11','2024-04-26'),(5,'2024-04-11','2024-04-26'),(6,'2024-04-11','2024-04-26'),(7,'2024-04-11','2024-04-26'),(8,'2024-04-11','2024-04-26'),(9,'2024-04-11','2024-04-26'),(10,'2024-04-11','2024-04-26'),(11,'2024-04-11','2024-04-26'),(12,'2024-04-11','2024-04-26'),(13,'2024-04-11','2024-04-26'),(14,'2024-04-11','2024-04-26');
...
CREATE TABLE `tbl_cuentasbancarias` (
  ...
  `No.Orden` int NOT NULL,
  PRIMARY KEY (`id_cuenta`),
  KEY `id_cliente` (`id_cliente`),
  CONSTRAINT `cuentasbancarias_ibfk_1` FOREIGN KEY (`id_cliente`) REFERENCES `tbl_clientes` (`id_cliente`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tbl_detalle_cotizacion` VALUES (16,26,1,14,1,9850),(17,26,1,14,2,9850);
...
CREATE TABLE `tbl_detallecompras` (
  ...
  CONSTRAINT `fk_tbl_detalleCompras_tbl_Encabezado_Compras1` FOREIGN KEY (`tbl_Encabezado_Compras_No.Orden`) REFERENCES `tbl_compras` (`No.Orden`),
...
CREATE TABLE `tbl_detalleordenescompra` (
  ...
  `OrdenesCompra_No.Orden` int NOT NULL,
  `cantidad_det` int NOT NULL,
  `totalProducto_det` double NOT NULL,
  `tbl_Producto_cod_producto` int NOT NULL,
  PRIMARY KEY (`id_detalle`),
  KEY `fk_DetalleOrdenesCompra_OrdenesCompra_idx` (`OrdenesCompra_No.Orden`),
  KEY `fk_tbl_DetalleOrdenesCompra_tbl_Producto1_idx` (`tbl_Producto_cod_producto`),
  CONSTRAINT `fk_DetalleOrdenesCompra_OrdenesCompra` FOREIGN KEY (`OrdenesCompra_No.Orden`) REFERENCES `tbl_ordenescompra` (`No.Orden`),
...
CREATE TABLE `tbl_facturaxpagar` (
  ...
  `tbl_Encabezado_Compras_No.Orden` int NOT NULL,
  PRIMARY KEY (`NoFactura`),
  KEY `fk_tbl_facturaXPagar_tbl_Encabezado_Compras1_idx` (`tbl_Encabezado_Compras_No.Orden`),
  CONSTRAINT `fk_tbl_facturaXPagar_tbl_Encabezado_Compras1` FOREIGN KEY (`tbl_Encabezado_Compras_No.Orden`) REFERENCES `tbl_compras` (`No.Orden`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tbl_movimientos` (
  ...
  `descripcion:movimiento` varchar(45) NOT NULL,
...
CREATE TABLE `tbl_ordenescompra` (
  ...
  KEY `fk_tbl_OrdenesCompra_tbl_Encabezado_Compras1_idx` (`tbl_Encabezado_Compras_No.Orden`),
  CONSTRAINT `fk_tbl_OrdenesCompra_tbl_Encabezado_Compras1` FOREIGN KEY (`tbl_Encabezado_Compras_No.Orden`) REFERENCES `tbl_compras` (`No.Orden`),
...
INSERT INTO `tbl_vendedor` VALUES (1,'Marcos','123','acctivo');
...
-- Dump completed on 2024-04-12  8:53:57
