...
INSERT INTO `tbl_detalle_cotizacion` VALUES (61,13,1,0,1,7500),(62,13,2,0,1,7500),(63,2,10,1,2,73500),(64,337,1,2,12,10123),(65,337,4,2,1,10123),(66,3,2,3,1,5615),(67,3,5,3,12,5615),(68,339,1,4,1,10000),(69,339,3,4,1,10000),(70,340,1,5,1,5000),(71,340,1,5,1,5000),(72,341,1,6,1,7500),(73,341,1,6,1,7500),(74,341,1,6,1,7500),(75,342,1,7,1,90700),(76,342,12,7,2,90700),(77,343,5,8,1,12500),(78,344,1,9,1,17200),(79,344,1,9,2,17200),(80,344,1,9,2,17200),(93,357,1,10,1,5000),(94,357,1,10,1,5000),(97,360,1,12,1,39250),(98,360,5,12,2,39250),(99,361,1,13,2,7965),(100,361,5,13,12,7965),(101,362,100,14,3,200000),(102,362,100,14,4,200000),(103,364,10,15,1,98500),(104,364,10,15,2,98500),(105,365,1,16,1,2500),(106,366,1,17,1,5000),(107,366,1,17,1,5000);
...
INSERT INTO `tbl_existencias` VALUES (1,1,1,259),(2,1,2,266),(3,1,12,280),(4,1,3,100),(5,1,4,100);
...
CREATE TABLE `tbl_trasladoprod` (
  ...
  `tbl_sucursales_id_sucursal_origen` int NOT NULL,
  `tbl_sucursales_id_sucursal_destino` int DEFAULT NULL,
  PRIMARY KEY (`id_trasladoprod`),
  KEY `fk_tbl_trasladoprod_tbl_sucursales1_idx` (`tbl_sucursales_id_sucursal_origen`),
  KEY `fk_tbl_sucursal2_idx` (`tbl_sucursales_id_sucursal_destino`),
  CONSTRAINT `fk_tbl_sucursal2` FOREIGN KEY (`tbl_sucursales_id_sucursal_destino`) REFERENCES `tbl_sucursales` (`id_sucursal`),
  CONSTRAINT `fk_tbl_sucursal_1` FOREIGN KEY (`tbl_sucursales_id_sucursal_origen`) REFERENCES `tbl_sucursales` (`id_sucursal`),
  CONSTRAINT `fk_tbl_trasladoprod_tbl_Producto1` FOREIGN KEY (`tbl_sucursales_id_sucursal_origen`) REFERENCES `tbl_sucursales` (`id_sucursal`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tbl_ventaspedido` VALUES (15,6,0),(16,5,1),(17,5,2),(18,5,3),(19,5,4),(20,5,5),(21,5,6),(22,5,7),(23,5,8),(24,5,9),(25,5,10),(26,5,12),(27,5,13),(28,5,14),(29,5,14),(30,6,15),(31,6,16),(32,6,17);
...
-- Dump completed on 2024-05-24 18:04:41
