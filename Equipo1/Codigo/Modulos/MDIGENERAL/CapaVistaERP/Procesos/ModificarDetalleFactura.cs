...
{
    public partial class ModificarDetalleFactura : Form
    {
        private Controlador cn = new Controlador();
        private FacturaporPagarModi FacturaporPagarModi;
        public ModificarDetalleFactura(FacturaporPagarModi facturaporPagarModi)
        {
            InitializeComponent();
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            FacturaporPagarModi.ActualizarDatoEnDataGridView(cant, idprod, nombre, desc, preciou, totf);
            this.Close();
        }
    }
}
