...
{
    public partial class ModificarDetalleOrdenes : Form
    {
        private Controlador cn = new Controlador();
        private OrdendeCompraModi OrdendeCompraModi;
        public ModificarDetalleOrdenes(OrdendeCompraModi ordendeCompraModi)
        {
            InitializeComponent();
        ...
        private void ModificarDetalleOrdenes_Load(object sender, EventArgs e)
        {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            OrdendeCompraModi.ActualizarDatoEnDataGridView(cant, idprod, nombre, desc, preciou, totf);
            this.Close();
        }
    }
}
