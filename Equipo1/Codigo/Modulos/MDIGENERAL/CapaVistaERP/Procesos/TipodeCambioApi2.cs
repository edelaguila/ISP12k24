...
{
    public partial class TipodeCambioApi2 : Form
    {
        private Banguat1.TipoCambio service = new Banguat1.TipoCambio();
        public TipodeCambioApi2()
        {
            InitializeComponent();
            CargarMonedas();
        }
        ...
        private void CargarMonedas()
        {
            try
            {
                ...
                Banguat1.InfoVariable infoVariables = service.VariablesDisponibles();
        ...
        private void btn_nueva_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (codigoMoneda != -1)
                {
                    ...
                    Banguat1.DataVariable data = service.TipoCambioFechaInicialMoneda(fechaInicial, codigoMoneda);
