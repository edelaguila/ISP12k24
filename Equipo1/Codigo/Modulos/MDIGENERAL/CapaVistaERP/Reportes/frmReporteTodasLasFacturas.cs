...
{
    public partial class frmReporteTodasLasFacturas : Form
    {
        public frmReporteTodasLasFacturas()
        {
            InitializeComponent();
            CargarReporte();
        }
        ...
        public void CargarReporte()
        {
            try
            {
                ...
                string reportPath = Path.Combine(directoryInfo.FullName, "Reportes", "Modulos", "Compras", "ReporteTodasFacturas.rpt");
