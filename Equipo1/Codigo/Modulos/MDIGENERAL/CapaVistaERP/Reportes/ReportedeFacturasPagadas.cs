...
{
    public partial class ReportedeFacturasPagadas : Form
    {
        public ReportedeFacturasPagadas()
        {
            InitializeComponent();
            CargarReporte();
        }
        public void CargarReporte()
        {
            try
            {
                ...
                string reportPath = Path.Combine(directoryInfo.FullName, "Reportes", "Modulos", "Compras", "ReportedeFcaturasPagadas.rpt");
