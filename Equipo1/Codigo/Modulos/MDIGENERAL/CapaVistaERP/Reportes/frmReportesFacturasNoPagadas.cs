...
{
    public partial class frmReportesFacturasNoPagadas : Form
    {
        public frmReportesFacturasNoPagadas()
        {
            InitializeComponent();
            CargarReporte();
        }
        ...
        public void CargarReporte()
        {
            try
            {
                ...
                string reportPath = Path.Combine(directoryInfo.FullName, "Reportes", "Modulos", "Compras", "ReportedeFacturasNoPagadas.rpt");
